...
module.exports = { setColors, getPalette, setFrameConfig, menu, homeMenu, message, scrollableMessage, liveScrollableMessage, flashMessage, assistantChatView, input, clear, out, W, IW, colWidth, truncateCols, makeBox, clampBoxKeepingBorders, renderHeader, enterAltScreen, exitAltScreen, showCursor, renderInlineMarkdown, renderChatBody, wrapCols };
