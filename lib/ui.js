...
function enterAltScreen() { process.stdout.write('\x1b[?1049h\x1b[2J\x1b[H'); }
function exitAltScreen()  { process.stdout.write('\x1b[2J\x1b[H\x1b[?1049l'); }

function paintRows(rows, { skipFirst = 0 } = {}) {
  let buf = skipFirst ? '' : '\x1b[2J\x1b[H';
...
async function menu(title, items, opts = {}) {
  ...
  return new Promise(resolve => {
    ...
    const onResize = () => draw(); // redraw on resize
