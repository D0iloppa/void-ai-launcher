...
async function runXtermWrappedOnce(tool, env, label, opts = {}) {
  ...
  const inputProfile = getInputProfile(toolCommand, { forceWrapperMouse: opts.forceWrapperMouse });
...
function getInputProfile(toolCommand, opts = {}) {
  if (opts.forceWrapperMouse) {
    return {
      name: toolCommand || 'default',
      wrapperMouse: true,
