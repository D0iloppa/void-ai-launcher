 ...
 *     (lib/void-persistent/switchProfile.js:193 encodeCwd 와 동일 — 아래 참고).
 *   - 그 jsonl 하나면 `claude --resume <uuid>` 로 충분히 재개된다. 인덱스/DB/
 *     사이드카 불필요. sessionId/cwd 필드는 있지만 크리덴셜 필드는 없다.
 *
 * lib/void-persistent/switchProfile.js 의 encodeCwd/captureLastSession 을
 * require 하지 않고 의도적으로 미러링(중복)한다 — messaging 과 void-persistent 는
